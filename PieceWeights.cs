        ...
        public static Dictionary<Piece.Piece, float[,]> PieceWeights = new Dictionary<Piece.Piece, float[,]>{
            {Piece.Presets.B_Pawn,
                new float[,] {
                    {0,0,0,0,0,0,0,0},
                    {2,2,2,2,2,2,2,2},
                    {1.5f,1.5f,1.6f,1.7f,1.7f,1.7f,1.5f,1.5f},
                    {1,1,1.5f,1.7f,1.8f,1.5f,1,1},
                    {1.2f,1,1.3f,1.7f,1.7f,1.3f,1,1.2f},
                    {1.5f,1.2f,1.1f,1.2f,1.2f,1.1f,1.2f,1.5f},
                    {1.3f,1.5f,1.5f,0.8f,0.8f,1.5f,1.5f,1.3f},
                    {0,0,0,0,0,0,0,0},
                }
            },
            {Piece.Presets.W_Pawn,
                new float[,] {
                    {0,0,0,0,0,0,0,0},
                    {1.3f,1.2f,1.5f,0.8f,0.8f,1.5f,1.2f,1.3f},
                    {1.3f,1.5f,1.5f,0.8f,0.8f,1.5f,1.5f,1.3f},
                    {1.2f,1,1.3f,1.7f,1.7f,1.3f,1,1.2f},
                    {1,1,1.5f,1.7f,1.8f,1.5f,1,1},
                    {1.5f,1.5f,1.6f,1.7f,1.7f,1.7f,1.5f,1.5f},
